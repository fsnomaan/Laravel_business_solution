            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
                <div class="card mb-3">
                    <div class="card-header">
                        <h3><i class="fa fa-hand-pointer-o"></i> Update Product</h3>
                        Update product details in this below form.
                    </div>
                        ...
                        <form action="{{route('product.update',$product->id)}}" method="post" data-parsley-validate novalidate name="product">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="weight" name="weight" type="number" value="{{$product->weight}}" required placeholder="Weight" required class="form-control">
