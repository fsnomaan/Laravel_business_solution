            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('product.store')}}" method="post" data-parsley-validate novalidate name="product">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="select2">Select Item Code <span class="text-danger">*</span></label>
                                    <select class="form-control select2" id="select2" required name="product_detail_id">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input data-parsley-equalto="#lc_code" type="text" name="lc_code" value="{{old('lc_code')}}" required placeholder="LC Code" class="form-control" id="lc_code">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input data-parsley-equalto="#coil" type="number" name="coil" value="{{old('coil')}}" placeholder="Coil" class="form-control" id="coil">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input data-parsley-equalto="#entry_date" type="text" name="entry_date" value="{{old('entry_date')}}" placeholder="Entry date" class="form-control" id="entry_date">
